...
function load_config() {
  ...
  BITBUCKET_USERNAME=`load_config_value ".cicd.bitbucket.username"`
  BITBUCKET_PASSWORD=`load_config_value ".cicd.bitbucket.password"`
  PROGET_USERNAME=`load_config_value ".cicd.proget.username"`
  PROGET_PASSWORD=`load_config_value ".cicd.proget.password"`
